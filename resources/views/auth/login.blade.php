...
<div class="container">
    <div class="row justify-content-center login-location">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header login-title">{{ __('message.Sign in to HapoLearn') }}</div>
                @if (session('error'))
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-md-10 sign-with">
                                <p class="title-google">{{ __('message.Sign in with') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-md-10 sign-with model-register">
                                <p class="title-google title-register">{{ __('message.or New to HapoLearn') }}</p>
                            </div>
                        </div>
